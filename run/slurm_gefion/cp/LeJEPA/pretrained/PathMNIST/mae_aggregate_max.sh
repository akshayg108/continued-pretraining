#!/bin/bash
#SBATCH --job-name=m-path-max-agg
...
#SBATCH --output=/dcai/projects/iu_0092/projects/cp/outputs/slurm-logs/lejepa-pathmnist-mae-max-agg-%j.out
