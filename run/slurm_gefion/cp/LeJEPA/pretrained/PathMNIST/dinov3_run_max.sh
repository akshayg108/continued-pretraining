...
#SBATCH --array=0-2
#SBATCH --output=/dcai/projects/iu_0092/projects/cp/outputs/slurm-logs/lejepa-pathmnist-max-%A_%a.out
...
CKPT_DIR="/dcai/projects/iu_0092/projects/cp/outputs/ckpts/cp/LeJEPA/pretrained/PathMNIST/DINOv3/all"
LOG_DIR="/dcai/projects/iu_0092/projects/cp/outputs/logs/cp/LeJEPA/pretrained/PathMNIST/DINOv3/all"
...
echo "=========================================="
echo "Starting LeJEPA-CP: ${DISPLAY_NAME} (MAX: 89996)"
...
run_single() {
    ...
    "${PYTHON_BIN}" -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project lejepa-cp-dinov3-pathmnist \
