...
#SBATCH --array=0-2
#SBATCH --output=/dcai/projects/iu_0092/projects/cp/outputs/slurm-logs/lejepa-food101-max-%A_%a.out
...
CKPT_DIR="/dcai/projects/iu_0092/projects/cp/outputs/ckpts/cp/LeJEPA/pretrained/Food101/DINOv3/all"
LOG_DIR="/dcai/projects/iu_0092/projects/cp/outputs/logs/cp/LeJEPA/pretrained/Food101/DINOv3/all"
