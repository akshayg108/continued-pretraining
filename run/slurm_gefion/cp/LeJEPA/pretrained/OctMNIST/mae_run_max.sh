...
#SBATCH --array=0-2
#SBATCH --output=/dcai/projects/iu_0092/projects/cp/outputs/slurm-logs/lejepa-octmnist-mae-max-%A_%a.out
...
CKPT_DIR="/dcai/projects/iu_0092/projects/cp/outputs/ckpts/cp/LeJEPA/pretrained/OctMNIST/MAE/all"
LOG_DIR="/dcai/projects/iu_0092/projects/cp/outputs/logs/cp/LeJEPA/pretrained/OctMNIST/MAE/all"
...
run_single() {
    ...
    "${PYTHON_BIN}" -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project lejepa-cp-mae-octmnist \
