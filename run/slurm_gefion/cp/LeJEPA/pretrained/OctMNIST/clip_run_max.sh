...
#SBATCH --array=0-2
#SBATCH --output=/dcai/projects/iu_0092/projects/cp/outputs/slurm-logs/lejepa-octmnist-clip-max-%A_%a.out
...
CKPT_DIR="/dcai/projects/iu_0092/projects/cp/outputs/ckpts/cp/LeJEPA/pretrained/OctMNIST/CLIP/all"
...
run_single() {
    ...
    "${PYTHON_BIN}" -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project lejepa-cp-clip-octmnist \
