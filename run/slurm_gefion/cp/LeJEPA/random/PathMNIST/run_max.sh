...
#SBATCH --array=0-2
#SBATCH --output=/dcai/projects/iu_0092/projects/cp/outputs/slurm-logs/lejepa-rand-pathmnist-max-%A_%a.out
...
CKPT_DIR="/dcai/projects/iu_0092/projects/cp/outputs/ckpts/cp/LeJEPA/random/PathMNIST"
LOG_DIR="/dcai/projects/iu_0092/projects/cp/outputs/logs/cp/LeJEPA/random/PathMNIST"
...
echo "=========================================="
echo "Starting LeJEPA-CP (random init): ${DISPLAY_NAME} (MAX: 89996)"
...
echo ""
echo "=========================================="
echo "LeJEPA-CP (random) ${DISPLAY_NAME} array task completed!"
echo "  Seed: ${SEED}"
