...
#SBATCH --array=0-0
#SBATCH --output=/dcai/projects/iu_0092/projects/cp/outputs/slurm-logs/simclr-max-%A_%a.out
...
rel_dir = f"cp/SimCLR/pretrained/{row['display_name']}/{row['backbone_tag']}/all"
...
echo "=========================================="
echo "Starting SimCLR-CP MAX run"
echo "Run ID: ${RUN_ID}"
...
echo ""
echo "=========================================="
echo "SimCLR-CP MAX run completed"
echo "Run ID: ${RUN_ID}"
echo "End Time: $(date)"
echo "=========================================="
