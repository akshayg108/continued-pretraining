...
STATUS_CSV="${COMBINED_DIR}/mae_max_status_${ARRAY_JOB_ID}.csv"
COMBINED_CSV="${COMBINED_DIR}/mae_max_combined_results_${ARRAY_JOB_ID}.csv"
JOB_FILE="${COMBINED_DIR}/mae_max_jobs_${ARRAY_JOB_ID}_${TIMESTAMP}.env"

{
    echo "workflow=mae_max"
