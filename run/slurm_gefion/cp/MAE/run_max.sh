...
#SBATCH --array=0-0
#SBATCH --output=/dcai/projects/iu_0092/projects/cp/outputs/slurm-logs/mae-max-%A_%a.out
...
rel_dir = f"cp/MAE/pretrained/{row['display_name']}/{row['backbone_tag']}/all"
