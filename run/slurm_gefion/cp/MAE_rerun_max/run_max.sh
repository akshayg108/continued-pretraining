...
#SBATCH --array=0-0
#SBATCH --output=/dcai/projects/iu_0092/projects/cp/outputs/slurm-logs/mae-rerun-max-%A_%a.out
...
rel_dir = f"cp/MAE_rerun_max/pretrained/{row['display_name']}/{row['backbone_tag']}/all"
...
echo "=========================================="
echo "Starting MAE-CP rerun MAX run"
echo "Run ID: ${RUN_ID}"
...
echo ""
echo "=========================================="
echo "MAE-CP rerun MAX run completed"
echo "Run ID: ${RUN_ID}"
echo "End Time: $(date)"
echo "=========================================="
