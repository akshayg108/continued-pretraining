#!/bin/bash
#SBATCH --job-name=rand-pre-oxpet-all
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-oxford_pet-all-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-oxford_pet-all-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/random-pre-cp-only/OxfordPet/SCRATCH/all"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/random-pre-cp-only/OxfordPet/SCRATCH/all"
...
echo ""
echo "=========================================="
echo "Starting Random Pre-CP-Only: ${DISPLAY_NAME} (SCRATCH, all)"
