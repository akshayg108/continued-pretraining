#!/bin/bash
#SBATCH --job-name=rand-pre-breast-all
...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/rand-pre-breastmnist-all-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/rand-pre-breastmnist-all-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/ckpts/random-pre-cp-only/BreastMNIST/SCRATCH/all"
LOG_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/logs/random-pre-cp-only/BreastMNIST/SCRATCH/all"
...
echo ""
echo "=========================================="
echo "Starting Random Pre-CP-Only: ${DISPLAY_NAME} (SCRATCH, all: 100,500,546)"
