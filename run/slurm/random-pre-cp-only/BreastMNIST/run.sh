...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-breastmnist-all-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-breastmnist-all-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/random-pre-cp-only/BreastMNIST/SCRATCH/all"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/random-pre-cp-only/BreastMNIST/SCRATCH/all"
