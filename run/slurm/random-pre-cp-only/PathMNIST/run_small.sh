...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-pathmnist-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-pathmnist-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/random-pre-cp-only/PathMNIST/SCRATCH/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/random-pre-cp-only/PathMNIST/SCRATCH/small"
