#!/bin/bash
#SBATCH --job-name=rand-pre-plantv-10000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-plant_village-10000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-plant_village-10000-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/random-pre-cp-only/PlantVillage/SCRATCH/10000"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/random-pre-cp-only/PlantVillage/SCRATCH/10000"
...
echo ""
echo "=========================================="
echo "Starting Random Pre-CP-Only: ${DISPLAY_NAME} (SCRATCH, 10000)"
