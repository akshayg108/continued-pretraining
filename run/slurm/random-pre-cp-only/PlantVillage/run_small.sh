#!/bin/bash
#SBATCH --job-name=rand-pre-plantv-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-plant_village-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-plant_village-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/random-pre-cp-only/PlantVillage/SCRATCH/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/random-pre-cp-only/PlantVillage/SCRATCH/small"
...
echo ""
echo "=========================================="
echo "Starting Random Pre-CP-Only: ${DISPLAY_NAME} (SCRATCH, small)"
