...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-cp-diet-fgvc_aircraft-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-cp-diet-fgvc_aircraft-%j.err
