#!/bin/bash
#SBATCH --job-name=rand-pre-fgvc-aircraft
...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/rand-pre-cp-diet-fgvc_aircraft-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/rand-pre-cp-diet-fgvc_aircraft-%j.err
...
# ============================================================
# n_samples list (FGVC_Aircraft MAX=3400)
# ============================================================
