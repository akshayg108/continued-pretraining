#!/bin/bash
#SBATCH --job-name=rand-pre-breastmnist
...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/rand-pre-cp-diet-breastmnist-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/rand-pre-cp-diet-breastmnist-%j.err
...
# ============================================================
# n_samples list (BreastMNIST MAX=546)
# ============================================================
