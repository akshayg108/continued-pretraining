#!/bin/bash
#SBATCH --job-name=rand-pre-organamnist
...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/rand-pre-cp-diet-organamnist-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/rand-pre-cp-diet-organamnist-%j.err
...
# ============================================================
# n_samples list (OrganAMNIST MAX=34561)
# ============================================================
NSAMPLES=(100 500 1000 10000 25000 34561)
