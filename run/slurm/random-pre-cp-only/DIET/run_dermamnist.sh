#!/bin/bash
#SBATCH --job-name=rand-pre-dermamnist
...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/rand-pre-cp-diet-dermamnist-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/rand-pre-cp-diet-dermamnist-%j.err
...
# ============================================================
# n_samples list (DermaMNIST MAX=7007)
# ============================================================
