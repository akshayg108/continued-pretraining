#!/bin/bash
#SBATCH --job-name=rand-pre-pathmnist
...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/rand-pre-cp-diet-pathmnist-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/rand-pre-cp-diet-pathmnist-%j.err
...
# ============================================================
# n_samples list (PathMNIST MAX=89996)
# ============================================================
NSAMPLES=(100 500 1000 10000 25000 89996)
