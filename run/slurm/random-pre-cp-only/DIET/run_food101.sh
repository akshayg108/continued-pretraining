#!/bin/bash
#SBATCH --job-name=rand-pre-food101
...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/rand-pre-cp-diet-food101-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/rand-pre-cp-diet-food101-%j.err
...
# ============================================================
# n_samples list (Food101 MAX=75750)
# ============================================================
NSAMPLES=(101 500 1000 10000 25000 75750)
