#!/bin/bash
#SBATCH --job-name=rand-pre-octmnist
...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/rand-pre-cp-diet-octmnist-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/rand-pre-cp-diet-octmnist-%j.err
...
# ============================================================
# n_samples list (OCTMNIST MAX=97477)
# ============================================================
NSAMPLES=(100 500 1000 10000 25000 97477)
