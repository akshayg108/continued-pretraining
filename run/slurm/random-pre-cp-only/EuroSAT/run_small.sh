#!/bin/bash
#SBATCH --job-name=rand-pre-eurosat-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-eurosat-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-eurosat-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/random-pre-cp-only/EuroSAT/SCRATCH/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/random-pre-cp-only/EuroSAT/SCRATCH/small"
