#!/bin/bash
#SBATCH --job-name=rand-pre-dtd-all
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-dtd-all-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-dtd-all-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/random-pre-cp-only/DTD/SCRATCH/all"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/random-pre-cp-only/DTD/SCRATCH/all"
