...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-octmnist-10000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-octmnist-10000-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/random-pre-cp-only/OctMNIST/SCRATCH/10000"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/random-pre-cp-only/OctMNIST/SCRATCH/10000"
