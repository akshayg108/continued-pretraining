#!/bin/bash
#SBATCH --job-name=rand-pre-flowers-all
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-flowers102-all-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-flowers102-all-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/random-pre-cp-only/Flowers102/SCRATCH/all"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/random-pre-cp-only/Flowers102/SCRATCH/all"
