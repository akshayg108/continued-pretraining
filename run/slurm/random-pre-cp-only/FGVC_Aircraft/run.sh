#!/bin/bash
#SBATCH --job-name=rand-pre-fgvc-all
...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/rand-pre-fgvc_aircraft-all-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/rand-pre-fgvc_aircraft-all-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/ckpts/random-pre-cp-only/FGVC_Aircraft/SCRATCH/all"
LOG_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/logs/random-pre-cp-only/FGVC_Aircraft/SCRATCH/all"
