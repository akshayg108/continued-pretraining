...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-galaxy10-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/rand-pre-galaxy10-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/random-pre-cp-only/Galaxy10/SCRATCH/max"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/random-pre-cp-only/Galaxy10/SCRATCH/max"
