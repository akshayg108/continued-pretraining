#!/bin/bash
#SBATCH --job-name=rand-pre-food-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/rand-pre-food101-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/rand-pre-food101-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/ckpts/random-pre-cp-only/Food101/SCRATCH/small"
LOG_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/logs/random-pre-cp-only/Food101/SCRATCH/small"
...
echo ""
echo "=========================================="
echo "Starting Random Pre-CP-Only: ${DISPLAY_NAME} (SCRATCH, n=small: 101,500,1000)"
