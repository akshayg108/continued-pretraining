...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/rest-lejepa-octmnist-clip-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/rest-lejepa-octmnist-clip-max-%j.err
