...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-food101-mae-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-food101-mae-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/pretrained/Food101/MAE/all"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/pretrained/Food101/MAE/all"
...
echo ""
echo "=========================================="
echo "Starting LeJEPA-CP: ${DISPLAY_NAME} (MAE, n=75750, MAX)"
...
echo ""
echo "=========================================="
echo "All LeJEPA-CP ${DISPLAY_NAME} MAE MAX experiments completed!"
