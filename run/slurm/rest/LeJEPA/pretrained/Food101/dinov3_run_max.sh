...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-food101-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-food101-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/pretrained/Food101/DINOv3/all"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/pretrained/Food101/DINOv3/all"
...
run_single() {
    ...
    python -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project lejepa-cp-dinov3-food101 \
...
echo ""
echo "=========================================="
echo "Starting LeJEPA-CP: ${DISPLAY_NAME} (n=75750, MAX)"
...
echo ""
echo "=========================================="
echo "All LeJEPA-CP ${DISPLAY_NAME} MAX experiments completed!"
