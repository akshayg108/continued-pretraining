...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/baseline-rest-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/baseline-rest-%j.err
...
# Missing baseline experiments only (from cookbook fill report).
# Partial-seed cases included — skip-detection re-runs only the absent seeds.
