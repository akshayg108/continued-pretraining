...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-pathmnist-mae-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-pathmnist-mae-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/pretrained/PathMNIST/MAE/all"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/pretrained/PathMNIST/MAE/all"
...
echo ""
echo "=========================================="
echo "Starting SimCLR-CP: ${DISPLAY_NAME} (MAE, n=89996, MAX)"
...
echo ""
echo "=========================================="
echo "All SimCLR-CP ${DISPLAY_NAME} MAE MAX experiments completed!"
