...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-octmnist-mae-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-octmnist-mae-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/pretrained/OctMNIST/MAE/all"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/pretrained/OctMNIST/MAE/all"
...
echo ""
echo "=========================================="
echo "Starting SimCLR-CP: ${DISPLAY_NAME} (MAE, MAX n=97477)"
