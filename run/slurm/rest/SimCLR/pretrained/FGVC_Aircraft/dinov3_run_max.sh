...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/rest-simclr-fgvc_aircraft-dinov3-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/rest-simclr-fgvc_aircraft-dinov3-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/pretrained/FGVC_Aircraft/DINOv3"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/pretrained/FGVC_Aircraft/DINOv3"
