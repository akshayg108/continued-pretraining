...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/rest-simclr-fgvc_aircraft-clip-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/rest-simclr-fgvc_aircraft-clip-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/pretrained/FGVC_Aircraft/CLIP"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/pretrained/FGVC_Aircraft/CLIP"
