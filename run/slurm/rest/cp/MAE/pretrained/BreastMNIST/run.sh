...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-breastmnist-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-breastmnist-%j.err
...
BASE_CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/pretrained/BreastMNIST"
BASE_LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/pretrained/BreastMNIST"
...
run_single() {
    ...
    local wandb_project="mae-cp-$(echo ${backbone_tag} | tr '[:upper:]' '[:lower:]')-${DATASET}"
...
echo ""
echo "=========================================="
echo "Starting MAE-CP: ${DISPLAY_NAME} (All Backbones)"
echo "freeze_epochs=${FREEZE_EPOCHS} num_trained_blocks=${NUM_TRAINED_BLOCKS}"
echo "Seeds: ${SEEDS[*]}"
echo "=========================================="
echo ""
...
echo ""
echo "=========================================="
echo "All MAE-CP ${DISPLAY_NAME} experiments completed!"
