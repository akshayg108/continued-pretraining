#!/bin/bash
#SBATCH --job-name=m-fgvc-n100-s44
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-fgvc-mae-n100-s44-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-fgvc-mae-n100-s44-%j.err
