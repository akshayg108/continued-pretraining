#!/bin/bash
#SBATCH --job-name=pre-flowers-mae
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-flowers102-mae-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-flowers102-mae-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/Flowers102/MAE"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/Flowers102/MAE"
