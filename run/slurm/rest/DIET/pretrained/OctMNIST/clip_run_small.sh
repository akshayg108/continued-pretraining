...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-octmnist-clip-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-octmnist-clip-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/pretrained/OctMNIST/CLIP/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/pretrained/OctMNIST/CLIP/small"
...
# ============================================================
# Stage this dataset's processed cache to node-local fast storage (same as cp-siglip).
# Slow /scratch random reads were starving the GPU -> low util -> admin cancel.
# ============================================================
case "${DATASET}" in
    octmnist|pathmnist|breastmnist|dermamnist|organamnist) PROCESSED_SUBPATH="med_mnist/${DATASET}-size=224" ;;
    *) PROCESSED_SUBPATH="${DATASET}" ;;
esac
...
if [ -d "${SRC_PROC}" ]; then
    ...
    echo "WARN: processed cache not found at ${SRC_PROC}; using /scratch DATA_DIR."
fi
...
echo ""
echo "=========================================="
echo "Starting DIET-CP: ${DISPLAY_NAME} (small: n=100,500,1000)"
...
echo ""
echo "=========================================="
echo "All DIET-CP ${DISPLAY_NAME} small experiments completed!"
