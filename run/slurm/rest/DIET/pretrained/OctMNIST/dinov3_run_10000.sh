...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-octmnist-10k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-octmnist-10k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/pretrained/OctMNIST/DINOv3/10k"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/pretrained/OctMNIST/DINOv3/10k"
...
echo ""
echo "=========================================="
echo "Starting DIET-CP: ${DISPLAY_NAME} (n=10000)"
...
echo ""
echo "=========================================="
echo "All DIET-CP ${DISPLAY_NAME} 10k experiments completed!"
