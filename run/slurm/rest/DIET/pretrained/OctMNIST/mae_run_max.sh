...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-octmnist-mae-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-octmnist-mae-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/pretrained/OctMNIST/MAE/all"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/pretrained/OctMNIST/MAE/all"
...
echo ""
echo "=========================================="
echo "Starting DIET-CP: ${DISPLAY_NAME} (MAE, MAX n=97477)"
