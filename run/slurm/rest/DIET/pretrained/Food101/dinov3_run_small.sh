...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-food101-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-food101-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/pretrained/Food101/DINOv3/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/pretrained/Food101/DINOv3/small"
...
run_single() {
    ...
    python -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project diet-cp-dinov3-food101 \
