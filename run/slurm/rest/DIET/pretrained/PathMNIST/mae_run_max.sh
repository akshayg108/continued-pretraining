...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-pathmnist-mae-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-pathmnist-mae-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/pretrained/PathMNIST/MAE/all"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/pretrained/PathMNIST/MAE/all"
...
echo ""
echo "=========================================="
echo "Starting DIET-CP: ${DISPLAY_NAME} (MAE, n=89996, MAX)"
...
echo ""
echo "=========================================="
echo "All DIET-CP ${DISPLAY_NAME} MAE MAX experiments completed!"
