...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/rest-mae-pathmnist-clip-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/rest-mae-pathmnist-clip-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/pretrained/PathMNIST/CLIP/all"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/pretrained/PathMNIST/CLIP/all"
...
run_single() {
    ...
    if ls ${CKPT_DIR}/cp/*_n${n_samples}_s${seed}.ckpt >/dev/null 2>&1; then
        echo "[SKIP] ${BACKBONE_TAG} | ${DATASET} n=${n_samples} seed=${seed} (ckpt exists)"
        return 0
    fi
...
echo ""
echo "=========================================="
echo "Starting MAE-CP: ${DISPLAY_NAME} (CLIP, n=89996, MAX)"
...
echo ""
echo "=========================================="
echo "All MAE-CP ${DISPLAY_NAME} CLIP MAX experiments completed!"
