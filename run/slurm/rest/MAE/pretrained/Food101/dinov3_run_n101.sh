...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/rest-mae-food101-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/rest-mae-food101-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/pretrained/Food101/DINOv3/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/pretrained/Food101/DINOv3/small"
...
echo ""
echo "=========================================="
echo "Starting MAE-CP: ${DISPLAY_NAME} (small: n=100,500,1000)"
...
echo ""
echo "=========================================="
echo "All MAE-CP ${DISPLAY_NAME} small experiments completed!"
