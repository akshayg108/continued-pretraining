...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/rest-mae-fgvc_aircraft-dinov3-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/rest-mae-fgvc_aircraft-dinov3-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/pretrained/FGVC_Aircraft/DINOv3"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/pretrained/FGVC_Aircraft/DINOv3"
...
echo ""
echo "=========================================="
echo "Starting MAE-CP: ${DISPLAY_NAME}"
...
echo ""
echo "=========================================="
echo "All MAE-CP ${DISPLAY_NAME} ${BACKBONE_TAG} experiments completed!"
