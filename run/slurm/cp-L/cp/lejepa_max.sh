...
#SBATCH --array=0-6
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/L-lejepa-%A_%a.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/L-lejepa-%A_%a.err

# ============================================================
# cp-L LeJEPA-CP — DINOv3 ViT-L/16 scale-robustness spot check
...
# a100-80g + accumulate x2 (per-step 128; LeJEPA 8 views is memory-heavy).
# Queue tip:  sbatch --array=0-6%3 run/slurm/cp-L/cp/lejepa_max.sh
# ============================================================
...
# ============================================================
# Parse optional arguments (e.g., sbatch lejepa_max.sh --seed 42)
# ============================================================
OVERRIDE_SEED=""
while [[ $# -gt 0 ]]; do
    case $1 in
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp-L/LeJEPA/pretrained/${DISPLAY_NAME}/DINOv3L"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp-L/LeJEPA/pretrained/${DISPLAY_NAME}/DINOv3L"
...
run_single() {
    ...
    python -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project lejepa-cp-dinov3L-${DATASET} \
