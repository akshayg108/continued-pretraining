...
#SBATCH --array=0-6
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/L-diet-%A_%a.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/L-diet-%A_%a.err

# ============================================================
# cp-L DIET-CP — DINOv3 ViT-L/16 scale-robustness spot check
...
# v100 is enough: DIET trains at effective batch 32 (main-grid recipe).
# Queue tip:  sbatch --array=0-6%3 run/slurm/cp-L/cp/diet_max.sh
# ============================================================
...
# ============================================================
# Parse optional arguments (e.g., sbatch diet_max.sh --seed 42)
# ============================================================
OVERRIDE_SEED=""
while [[ $# -gt 0 ]]; do
    case $1 in
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp-L/DIET/pretrained/${DISPLAY_NAME}/DINOv3L"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp-L/DIET/pretrained/${DISPLAY_NAME}/DINOv3L"
...
EPOCHS=150
EFFECTIVE_BATCH=32
ACCUMULATE_GRAD_BATCHES=1   # DIET main-grid recipe: small batch
...
run_single() {
    ...
    python -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project diet-cp-dinov3L-${DATASET} \
