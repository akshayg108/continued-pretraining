...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/baseline-pretrained-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/baseline-pretrained-%j.err
