...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/baseline-randomized-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/baseline-randomized-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/ckpts/baseline-only"
LOG_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/logs/baseline-only"
