...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/baseline-randomized-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/baseline-randomized-%j.err
