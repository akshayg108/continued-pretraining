#!/bin/bash
#SBATCH --job-name=baseline-randomized
...
#SBATCH --output=/scratch/gs4133/zhd/Continued-Pretraining/outputs/slurm-log/baseline-randomized-%j.out
#SBATCH --error=/scratch/gs4133/zhd/Continued-Pretraining/outputs/slurm-log/baseline-randomized-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/Continued-Pretraining/outputs/ckpts/baseline-only"
LOG_DIR="/scratch/gs4133/zhd/Continued-Pretraining/outputs/logs/baseline-only"
