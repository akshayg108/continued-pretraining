...
# Write CSV header
# ============================================================
echo "dataset,n_samples,model_size,run,knn_f1,knn_f1_std,linear_f1,linear_f1_std,sft_f1,sft_f1_std" > ${CSV_FILE}
...
for i, seed in enumerate(seeds):
    ...
    with open(csv_file, "a") as f:
        ...
        f.write(f"{display_name},{n_samples},{model_size},{i},{knn_str},,{lin_str},,{sft_str},\n")
...
if len(knn_f1s) > 0 or len(linear_f1s) > 0 or len(sft_f1s) > 0:
    ...
    with open(csv_file, "a") as f:
        f.write(f"{display_name},{n_samples},{model_size},average,{knn_mean},{knn_std},{lin_mean},{lin_std},{sft_mean},{sft_std}\n")

    print(f"  {display_name} n={n_samples}: knn_f1={knn_mean}±{knn_std} linear_f1={lin_mean}±{lin_std} sft_f1={sft_mean}±{sft_std}")
else:
