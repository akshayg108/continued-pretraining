#!/bin/bash
#SBATCH --job-name=pre-food-mae-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-food101-mae-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-food101-mae-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/Food101/MAE/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/Food101/MAE/small"
