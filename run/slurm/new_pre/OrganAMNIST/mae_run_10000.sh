#!/bin/bash
#SBATCH --job-name=pre-organ-mae-10k
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-organamnist-mae-10k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-organamnist-mae-10k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/OrganAMNIST/MAE/10k"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/OrganAMNIST/MAE/10k"
