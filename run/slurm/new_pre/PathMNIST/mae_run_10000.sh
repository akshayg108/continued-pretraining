#!/bin/bash
#SBATCH --job-name=pre-path-mae-10k
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-pathmnist-mae-10k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-pathmnist-mae-10k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/PathMNIST/MAE/10k"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/PathMNIST/MAE/10k"
...
echo ""
echo "=========================================="
echo "Starting Pre-CP-Only: ${DISPLAY_NAME} (MAE, n=10000)"
