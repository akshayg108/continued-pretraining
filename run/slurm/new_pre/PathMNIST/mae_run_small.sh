#!/bin/bash
#SBATCH --job-name=pre-path-mae-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-pathmnist-mae-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-pathmnist-mae-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/PathMNIST/MAE/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/PathMNIST/MAE/small"
