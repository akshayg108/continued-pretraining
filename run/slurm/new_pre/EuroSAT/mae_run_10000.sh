#!/bin/bash
#SBATCH --job-name=pre-eurosat-mae-10000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-eurosat-mae-10000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-eurosat-mae-10000-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/EuroSAT/MAE/10000"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/EuroSAT/MAE/10000"
