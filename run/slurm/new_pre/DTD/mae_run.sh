...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-dtd-mae-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-dtd-mae-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/DTD/MAE"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/DTD/MAE"
