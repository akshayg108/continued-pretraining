...
BASE_CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp-siglip/cp/LeJEPA/BreastMNIST"
BASE_LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp-siglip/cp/LeJEPA/BreastMNIST"
