...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-fgvc_aircraft-siglip-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-fgvc_aircraft-siglip-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp-siglip/cp/LeJEPA/FGVC_Aircraft/SigLIP"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp-siglip/cp/LeJEPA/FGVC_Aircraft/SigLIP"
...
# ============================================================
PROCESSED_SUBPATH="fgvc_aircraft"
