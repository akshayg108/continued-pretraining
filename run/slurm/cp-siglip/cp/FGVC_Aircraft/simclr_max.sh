...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp-siglip/cp/SimCLR/FGVC_Aircraft/SigLIP"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp-siglip/cp/SimCLR/FGVC_Aircraft/SigLIP"
