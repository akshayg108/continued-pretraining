...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-octmnist-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-octmnist-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp-siglip/cp/LeJEPA/OctMNIST/SigLIP/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp-siglip/cp/LeJEPA/OctMNIST/SigLIP/small"
...
# ============================================================
PROCESSED_SUBPATH="med_mnist/octmnist-size=224"
...
run_single() {
    ...
    python -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project lejepa-cp-siglip-${DATASET} \
...
echo ""
echo "=========================================="
echo "Starting LeJEPA-CP: ${DISPLAY_NAME} (small: n=100,500,1000)"
...
echo ""
echo "=========================================="
echo "All LeJEPA-CP ${DISPLAY_NAME} small experiments completed!"
