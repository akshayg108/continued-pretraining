...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp-siglip/cp/LeJEPA/Flowers102/SigLIP"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp-siglip/cp/LeJEPA/Flowers102/SigLIP"
