...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp-siglip/cp/SimCLR/CUB200/SigLIP"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp-siglip/cp/SimCLR/CUB200/SigLIP"
