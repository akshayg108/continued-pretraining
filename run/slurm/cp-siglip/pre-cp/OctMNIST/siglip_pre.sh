...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/precp-octmnist-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/precp-octmnist-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp-siglip/pre-cp/OctMNIST/SigLIP/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp-siglip/pre-cp/OctMNIST/SigLIP/small"
