...
BASE_CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp-siglip/pre-cp/BreastMNIST"
BASE_LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp-siglip/pre-cp/BreastMNIST"
