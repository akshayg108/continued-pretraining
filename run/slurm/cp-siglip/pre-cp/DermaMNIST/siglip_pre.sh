...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp-siglip/pre-cp/DermaMNIST/SigLIP"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp-siglip/pre-cp/DermaMNIST/SigLIP"
