#!/bin/bash
#SBATCH --job-name=d-euro-din-max
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-eurosat-dinov3-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-eurosat-dinov3-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/pretrained/EuroSAT/DINOv3/max"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/pretrained/EuroSAT/DINOv3/max"
