#!/bin/bash
#SBATCH --job-name=d-euro-cli-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-eurosat-clip-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-eurosat-clip-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/pretrained/EuroSAT/CLIP/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/pretrained/EuroSAT/CLIP/small"
