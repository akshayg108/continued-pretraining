#!/bin/bash
#SBATCH --job-name=d-euro-mae-max
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-eurosat-mae-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-eurosat-mae-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/pretrained/EuroSAT/MAE/max"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/pretrained/EuroSAT/MAE/max"
