#!/bin/bash
#SBATCH --job-name=d-eurosat-mae-1000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-eurosat-mae-1000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-eurosat-mae-1000-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/pretrained/EuroSAT/1000"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/pretrained/EuroSAT/1000"
