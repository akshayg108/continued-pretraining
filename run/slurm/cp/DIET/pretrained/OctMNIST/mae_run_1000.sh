...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-octmnist-mae-1k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-octmnist-mae-1k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/pretrained/OctMNIST/MAE/1k"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/pretrained/OctMNIST/MAE/1k"
...
echo ""
echo "=========================================="
echo "All DIET-CP ${DISPLAY_NAME} MAE 1k experiments completed!"
