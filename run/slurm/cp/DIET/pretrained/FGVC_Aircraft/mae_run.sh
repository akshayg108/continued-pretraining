...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-fgvc_aircraft-mae-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-fgvc_aircraft-mae-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/pretrained/FGVC_Aircraft/MAE"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/pretrained/FGVC_Aircraft/MAE"
