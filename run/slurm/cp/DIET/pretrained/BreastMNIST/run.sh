...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-breastmnist-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-breastmnist-%j.err
...
BASE_CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/pretrained/BreastMNIST"
BASE_LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/pretrained/BreastMNIST"
...
run_single() {
    ...
    local wandb_project="diet-cp-$(echo ${backbone_tag} | tr '[:upper:]' '[:lower:]')-${DATASET}"
...
echo ""
echo "=========================================="
echo "Starting DIET-CP: ${DISPLAY_NAME} (All Backbones)"
echo "freeze_epochs=${FREEZE_EPOCHS} num_trained_blocks=${NUM_TRAINED_BLOCKS}"
echo "Seeds: ${SEEDS[*]}"
echo "=========================================="
echo ""
...
echo ""
echo "=========================================="
echo "All DIET-CP ${DISPLAY_NAME} experiments completed!"
