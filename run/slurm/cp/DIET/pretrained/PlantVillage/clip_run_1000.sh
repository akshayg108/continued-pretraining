#!/bin/bash
#SBATCH --job-name=d-plantv-cli-1000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-plant_village-clip-1000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-plant_village-clip-1000-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/pretrained/PlantVillage/1000"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/pretrained/PlantVillage/1000"
...
echo ""
echo "=========================================="
echo "Starting DIET-CP: ${DISPLAY_NAME} (CLIP, 1000)"
