#!/bin/bash
#SBATCH --job-name=d-plvi-mae-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-plant_village-mae-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-plant_village-mae-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/pretrained/PlantVillage/MAE/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/pretrained/PlantVillage/MAE/small"
...
echo ""
echo "=========================================="
echo "Starting DIET-CP: ${DISPLAY_NAME} (MAE, small)"
