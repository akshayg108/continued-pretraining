#!/bin/bash
#SBATCH --job-name=d-plantv-cli-max
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/pretrained/PlantVillage/max"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/pretrained/PlantVillage/max"
