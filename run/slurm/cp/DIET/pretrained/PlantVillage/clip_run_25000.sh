#!/bin/bash
#SBATCH --job-name=d-plvi-cli-25000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-plant_village-clip-25000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-plant_village-clip-25000-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/pretrained/PlantVillage/CLIP/25000"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/pretrained/PlantVillage/CLIP/25000"
...
echo ""
echo "=========================================="
echo "Starting DIET-CP: ${DISPLAY_NAME} (CLIP, 25000)"
