...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-pathmnist-mae-1k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-pathmnist-mae-1k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/pretrained/PathMNIST/MAE/1k"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/pretrained/PathMNIST/MAE/1k"
...
echo ""
echo "=========================================="
echo "All DIET-CP ${DISPLAY_NAME} MAE n=1000 experiments completed!"
