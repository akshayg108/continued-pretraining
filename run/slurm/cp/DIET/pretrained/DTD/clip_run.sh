...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-dtd-clip-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-dtd-clip-%j.err
