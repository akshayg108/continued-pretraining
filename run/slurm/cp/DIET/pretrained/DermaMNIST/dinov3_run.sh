...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-dermamnist-dinov3-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-dermamnist-dinov3-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/pretrained/DermaMNIST/DINOv3"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/pretrained/DermaMNIST/DINOv3"
