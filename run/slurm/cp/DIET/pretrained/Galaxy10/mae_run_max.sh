...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-galaxy10-mae-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-galaxy10-mae-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/pretrained/Galaxy10/MAE/all"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/pretrained/Galaxy10/MAE/all"
...
echo ""
echo "=========================================="
echo "Starting DIET-CP: ${DISPLAY_NAME} (MAE, MAX n=14188)"
echo "=========================================="
