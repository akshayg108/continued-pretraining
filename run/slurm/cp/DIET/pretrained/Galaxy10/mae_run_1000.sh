...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-galaxy10-mae-1k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-galaxy10-mae-1k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/pretrained/Galaxy10/MAE/1k"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/pretrained/Galaxy10/MAE/1k"
...
echo ""
echo "=========================================="
echo "Starting DIET-CP: ${DISPLAY_NAME} (MAE, n=1000)"
echo "=========================================="
