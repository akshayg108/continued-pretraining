...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-octmnist-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-octmnist-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/random/OctMNIST"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/random/OctMNIST"
