...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-organamnist-25k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-organamnist-25k-%j.err
...
echo ""
echo "=========================================="
echo "Starting DIET-CP (random init): ${DISPLAY_NAME} (n=25000)"
