...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-oxford_pet-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-oxford_pet-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/random/OxfordPet"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/random/OxfordPet"
...
echo ""
echo "=========================================="
echo "Starting DIET-CP (random): ${DISPLAY_NAME} (random)"
