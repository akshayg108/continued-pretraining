...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-food101-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-food101-max-%j.err
...
echo ""
echo "=========================================="
echo "Starting DIET-CP (random init): ${DISPLAY_NAME} (MAX: 75750)"
