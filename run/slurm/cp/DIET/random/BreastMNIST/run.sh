...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-breastmnist-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-breastmnist-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/random/BreastMNIST"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/random/BreastMNIST"
...
run_single() {
    ...
    python -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project diet-cp-rand-breastmnist \
...
echo ""
echo "=========================================="
echo "Starting DIET-CP (random init): ${DISPLAY_NAME} (all: 100,500,546)"
...
echo ""
echo "=========================================="
echo "All DIET-CP (random) ${DISPLAY_NAME} experiments completed!"
