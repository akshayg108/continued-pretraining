#!/bin/bash
#SBATCH --job-name=dr-eurosat-max
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-eurosat-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-eurosat-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/random/EuroSAT/max"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/random/EuroSAT/max"
