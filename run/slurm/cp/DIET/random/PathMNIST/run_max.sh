...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-pathmnist-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-pathmnist-max-%j.err
...
echo ""
echo "=========================================="
echo "Starting DIET-CP (random init): ${DISPLAY_NAME} (MAX: 89996)"
