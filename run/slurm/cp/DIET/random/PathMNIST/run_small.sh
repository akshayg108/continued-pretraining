...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-pathmnist-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-pathmnist-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/random/PathMNIST"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/random/PathMNIST"
...
run_single() {
    ...
    python -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project diet-cp-rand-pathmnist \
...
echo ""
echo "=========================================="
echo "Starting DIET-CP (random init): ${DISPLAY_NAME} (small: 100,500,1000)"
