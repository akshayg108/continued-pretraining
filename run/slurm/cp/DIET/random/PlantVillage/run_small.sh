#!/bin/bash
#SBATCH --job-name=dr-plantv-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-plant_village-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-plant_village-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/random/PlantVillage/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/random/PlantVillage/small"
...
echo ""
echo "=========================================="
echo "Starting DIET-CP (random): ${DISPLAY_NAME} (random, small)"
