#!/bin/bash
#SBATCH --job-name=dr-plantv-10000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-plant_village-10000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-plant_village-10000-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/random/PlantVillage/10000"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/random/PlantVillage/10000"
...
echo ""
echo "=========================================="
echo "Starting DIET-CP (random): ${DISPLAY_NAME} (random, 10000)"
