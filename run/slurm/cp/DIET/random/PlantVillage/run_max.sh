...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-plant_village-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/diet-rand-plant_village-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/DIET/random/PlantVillage/max"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/DIET/random/PlantVillage/max"
...
echo ""
echo "=========================================="
echo "Starting DIET-CP (random): ${DISPLAY_NAME} (random, max)"
