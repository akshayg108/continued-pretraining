...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/simclr-pathmnist-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/simclr-pathmnist-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/ckpts/cp/SimCLR/PathMNIST/DINOv3/all"
LOG_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/logs/cp/SimCLR/PathMNIST/DINOv3/all"
