...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/simclr-breastmnist-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/simclr-breastmnist-%j.err
...
BASE_CKPT_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/ckpts/cp/SimCLR/BreastMNIST"
BASE_LOG_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/logs/cp/SimCLR/BreastMNIST"
