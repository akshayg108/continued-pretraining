...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/simclr-fgvc_aircraft-mae-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/simclr-fgvc_aircraft-mae-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/ckpts/cp/SimCLR/FGVC_Aircraft/MAE"
LOG_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/logs/cp/SimCLR/FGVC_Aircraft/MAE"
