...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-dermamnist-clip-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-dermamnist-clip-%j.err
