...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-pathmnist-clip-1k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-pathmnist-clip-1k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/pretrained/PathMNIST/CLIP/1k"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/pretrained/PathMNIST/CLIP/1k"
