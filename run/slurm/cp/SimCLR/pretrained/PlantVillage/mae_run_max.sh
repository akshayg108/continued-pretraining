#!/bin/bash
#SBATCH --job-name=s-plvi-mae-max
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-plant_village-mae-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-plant_village-mae-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/pretrained/PlantVillage/MAE/all"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/pretrained/PlantVillage/MAE/all"
...
echo ""
echo "=========================================="
echo "Starting SimCLR-CP: ${DISPLAY_NAME} (MAE, max)"
