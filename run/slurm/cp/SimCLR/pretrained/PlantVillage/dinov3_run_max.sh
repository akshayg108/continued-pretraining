#!/bin/bash
#SBATCH --job-name=s-plvi-din-max
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-plant_village-dinov3-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-plant_village-dinov3-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/pretrained/PlantVillage/DINOv3/max"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/pretrained/PlantVillage/DINOv3/max"
...
echo ""
echo "=========================================="
echo "Starting SimCLR-CP: ${DISPLAY_NAME} (DINOv3, max)"
