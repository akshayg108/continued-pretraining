#!/bin/bash
#SBATCH --job-name=s-plvi-cli-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-plant_village-clip-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-plant_village-clip-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/pretrained/PlantVillage/CLIP/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/pretrained/PlantVillage/CLIP/small"
...
echo ""
echo "=========================================="
echo "Starting SimCLR-CP: ${DISPLAY_NAME} (CLIP, small)"
