#!/bin/bash
#SBATCH --job-name=s-plvi-mae-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-plant_village-mae-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-plant_village-mae-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/pretrained/PlantVillage/MAE/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/pretrained/PlantVillage/MAE/small"
...
echo ""
echo "=========================================="
echo "Starting SimCLR-CP: ${DISPLAY_NAME} (MAE, small)"
