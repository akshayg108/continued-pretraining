...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-fgvc_aircraft-siglip-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-fgvc_aircraft-siglip-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/pretrained/FGVC_Aircraft/SigLIP"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/pretrained/FGVC_Aircraft/SigLIP"
