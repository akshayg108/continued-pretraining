...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-eurosat-siglip-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-eurosat-siglip-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/pretrained/EuroSAT/SigLIP/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/pretrained/EuroSAT/SigLIP/small"
