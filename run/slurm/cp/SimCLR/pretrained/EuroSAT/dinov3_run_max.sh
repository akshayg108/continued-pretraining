#!/bin/bash
#SBATCH --job-name=s-euro-din-max
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-eurosat-dinov3-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-eurosat-dinov3-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/pretrained/EuroSAT/DINOv3/all"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/pretrained/EuroSAT/DINOv3/all"
