#!/bin/bash
#SBATCH --job-name=s-euro-mae-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-eurosat-mae-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-eurosat-mae-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/pretrained/EuroSAT/MAE/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/pretrained/EuroSAT/MAE/small"
