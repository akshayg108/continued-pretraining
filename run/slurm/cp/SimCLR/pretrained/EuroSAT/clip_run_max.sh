#!/bin/bash
#SBATCH --job-name=s-euro-cli-max
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-eurosat-clip-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-eurosat-clip-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/pretrained/EuroSAT/CLIP/max"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/pretrained/EuroSAT/CLIP/max"
