...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-dtd-siglip-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-dtd-siglip-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/pretrained/DTD/SigLIP"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/pretrained/DTD/SigLIP"
