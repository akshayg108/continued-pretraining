...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-galaxy10-clip-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-galaxy10-clip-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/pretrained/Galaxy10/CLIP/all"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/pretrained/Galaxy10/CLIP/all"
