...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/simclr-galaxy10-clip-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/simclr-galaxy10-clip-max-%j.err
...
cd /scratch/gs4133/zhd/CP-MAE/continued-pretraining
...
CKPT_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/ckpts/cp/SimCLR/Galaxy10/CLIP/all"
LOG_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/logs/cp/SimCLR/Galaxy10/CLIP/all"
