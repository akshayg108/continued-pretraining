...
#SBATCH --output=/scratch/gs4133/zhd/Continued-Pretraining/outputs/slurm-log/simclr-galaxy10-clip-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/Continued-Pretraining/outputs/slurm-log/simclr-galaxy10-clip-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/Continued-Pretraining/outputs/ckpts/cp/SimCLR/Galaxy10/CLIP/all"
LOG_DIR="/scratch/gs4133/zhd/Continued-Pretraining/outputs/logs/cp/SimCLR/Galaxy10/CLIP/all"
...
echo ""
echo "=========================================="
echo "Starting SimCLR-CP: ${DISPLAY_NAME} (CLIP, MAX n=14188)"
echo "=========================================="
