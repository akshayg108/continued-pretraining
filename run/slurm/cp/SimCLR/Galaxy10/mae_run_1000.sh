...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/simclr-galaxy10-mae-1k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/simclr-galaxy10-mae-1k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/ckpts/cp/SimCLR/Galaxy10/MAE/1k"
LOG_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/logs/cp/SimCLR/Galaxy10/MAE/1k"
...
echo ""
echo "=========================================="
echo "Starting SimCLR-CP: ${DISPLAY_NAME} (MAE, n=1000)"
echo "=========================================="
