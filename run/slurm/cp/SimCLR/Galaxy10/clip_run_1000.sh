...
#SBATCH --output=/scratch/gs4133/zhd/Continued-Pretraining/outputs/slurm-log/simclr-galaxy10-clip-1k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/Continued-Pretraining/outputs/slurm-log/simclr-galaxy10-clip-1k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/Continued-Pretraining/outputs/ckpts/cp/SimCLR/Galaxy10/CLIP/1k"
LOG_DIR="/scratch/gs4133/zhd/Continued-Pretraining/outputs/logs/cp/SimCLR/Galaxy10/CLIP/1k"
...
echo ""
echo "=========================================="
echo "Starting SimCLR-CP: ${DISPLAY_NAME} (CLIP, n=1000)"
echo "=========================================="
