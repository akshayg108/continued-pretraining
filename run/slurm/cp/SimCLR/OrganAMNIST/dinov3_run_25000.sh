...
#SBATCH --output=/scratch/gs4133/zhd/Continued-Pretraining/outputs/slurm-log/simclr-organamnist-25k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/Continued-Pretraining/outputs/slurm-log/simclr-organamnist-25k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/Continued-Pretraining/outputs/ckpts/cp/SimCLR/OrganAMNIST/DINOv3/25k"
LOG_DIR="/scratch/gs4133/zhd/Continued-Pretraining/outputs/logs/cp/SimCLR/OrganAMNIST/DINOv3/25k"
...
echo ""
echo "=========================================="
echo "All SimCLR-CP ${DISPLAY_NAME} 25k experiments completed!"
