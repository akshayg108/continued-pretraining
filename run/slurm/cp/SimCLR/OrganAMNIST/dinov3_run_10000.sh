...
#SBATCH --output=/scratch/gs4133/zhd/Continued-Pretraining/outputs/slurm-log/simclr-organamnist-10k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/Continued-Pretraining/outputs/slurm-log/simclr-organamnist-10k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/Continued-Pretraining/outputs/ckpts/cp/SimCLR/OrganAMNIST/DINOv3/10k"
LOG_DIR="/scratch/gs4133/zhd/Continued-Pretraining/outputs/logs/cp/SimCLR/OrganAMNIST/DINOv3/10k"
...
echo ""
echo "=========================================="
echo "All SimCLR-CP ${DISPLAY_NAME} 10k experiments completed!"
