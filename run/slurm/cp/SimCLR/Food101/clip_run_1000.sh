...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/simclr-food101-clip-1k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/simclr-food101-clip-1k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/ckpts/cp/SimCLR/Food101/CLIP/1k"
LOG_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/logs/cp/SimCLR/Food101/CLIP/1k"
...
if any(len(l) > 0 for l in [pre_knn_f1s, pre_linear_f1s, post_knn_f1s, post_linear_f1s]):
...
echo ""
echo "=========================================="
echo "All SimCLR-CP ${DISPLAY_NAME} CLIP n=1000 experiments completed!"
