...
#SBATCH --output=/scratch/gs4133/zhd/Continued-Pretraining/outputs/slurm-log/simclr-octmnist-clip-1k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/Continued-Pretraining/outputs/slurm-log/simclr-octmnist-clip-1k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/Continued-Pretraining/outputs/ckpts/cp/SimCLR/OctMNIST/CLIP/1k"
LOG_DIR="/scratch/gs4133/zhd/Continued-Pretraining/outputs/logs/cp/SimCLR/OctMNIST/CLIP/1k"
...
echo ""
echo "=========================================="
echo "All SimCLR-CP ${DISPLAY_NAME} CLIP 1k experiments completed!"
