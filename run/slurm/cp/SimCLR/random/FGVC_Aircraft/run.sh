...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-rand-fgvc-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-rand-fgvc-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/random/FGVC_Aircraft"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/random/FGVC_Aircraft"
...
run_single() {
    ...
    python -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project simclr-cp-rand-fgvc_aircraft \
