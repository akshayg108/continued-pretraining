#!/bin/bash
#SBATCH --job-name=sr-plantv-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-rand-plant_village-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-rand-plant_village-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/random/PlantVillage/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/random/PlantVillage/small"
...
echo ""
echo "=========================================="
echo "Starting SimCLR-CP (random): ${DISPLAY_NAME} (random, small)"
