#!/bin/bash
#SBATCH --job-name=sr-plantv-25000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-rand-plant_village-25000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-rand-plant_village-25000-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/random/PlantVillage/25000"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/random/PlantVillage/25000"
...
run_single() {
    ...
    echo "=========================================="
    echo "[RUN] SimCLR-CP (random) ${BACKBONE_TAG} | ${DATASET} | n=${n_samples} | seed=${seed}"
    ...
    python -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project simclr-cp-random-scratch-${DATASET} \
...
echo ""
echo "=========================================="
echo "Starting SimCLR-CP (random): ${DISPLAY_NAME} (random, 25000)"
...
echo ""
echo "=========================================="
echo "All SimCLR-CP (random) ${DISPLAY_NAME} ${BACKBONE_TAG} experiments completed!"
