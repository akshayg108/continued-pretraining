...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-rand-dtd-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-rand-dtd-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/random/DTD"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/random/DTD"
