...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-rand-galaxy10-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-rand-galaxy10-max-%j.err
...
echo ""
echo "=========================================="
echo "Starting SimCLR-CP (random init): ${DISPLAY_NAME} (MAX: 14188)"
