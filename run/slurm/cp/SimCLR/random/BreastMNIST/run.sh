...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-rand-breastmnist-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-rand-breastmnist-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/random/BreastMNIST"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/random/BreastMNIST"
...
run_single() {
    ...
    python -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project simclr-cp-rand-breastmnist \
...
echo ""
echo "=========================================="
echo "Starting SimCLR-CP (random init): ${DISPLAY_NAME} (all: 100,500,546)"
...
echo ""
echo "=========================================="
echo "All SimCLR-CP (random) ${DISPLAY_NAME} experiments completed!"
