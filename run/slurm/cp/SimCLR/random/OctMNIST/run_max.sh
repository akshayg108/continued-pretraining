...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-rand-octmnist-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-rand-octmnist-max-%j.err
...
echo ""
echo "=========================================="
echo "Starting SimCLR-CP (random init): ${DISPLAY_NAME} (MAX: 97477)"
