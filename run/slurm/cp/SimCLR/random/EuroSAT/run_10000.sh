#!/bin/bash
#SBATCH --job-name=sr-eurosat-10000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-rand-eurosat-10000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-rand-eurosat-10000-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/random/EuroSAT/10000"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/random/EuroSAT/10000"
...
echo ""
echo "=========================================="
echo "Starting SimCLR-CP (random): ${DISPLAY_NAME} (random, 10000)"
