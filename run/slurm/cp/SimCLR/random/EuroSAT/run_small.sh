#!/bin/bash
#SBATCH --job-name=sr-eurosat-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-rand-eurosat-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/simclr-rand-eurosat-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/SimCLR/random/EuroSAT/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/SimCLR/random/EuroSAT/small"
