...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-rand-food101-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-rand-food101-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/random/Food101"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/random/Food101"
...
run_single() {
    ...
    python -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project lejepa-cp-rand-food101 \
...
echo ""
echo "=========================================="
echo "Starting LeJEPA-CP (random init): ${DISPLAY_NAME} (small: 101,500,1000)"
