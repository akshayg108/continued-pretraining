...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-rand-fgvc-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-rand-fgvc-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/random/FGVC_Aircraft"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/random/FGVC_Aircraft"
...
run_single() {
    ...
    python -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project lejepa-cp-rand-fgvc_aircraft \
...
echo ""
echo "=========================================="
echo "Starting LeJEPA-CP (random init): ${DISPLAY_NAME} (all: 100,500,1000,3400)"
