#!/bin/bash
#SBATCH --job-name=lr-eurosat-max
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-rand-eurosat-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-rand-eurosat-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/random/EuroSAT/max"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/random/EuroSAT/max"
