...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-rand-pathmnist-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-rand-pathmnist-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/random/PathMNIST"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/random/PathMNIST"
...
run_single() {
    ...
    python -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project lejepa-cp-rand-pathmnist \
