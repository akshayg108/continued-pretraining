...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-rand-organamnist-10k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-rand-organamnist-10k-%j.err
...
echo ""
echo "=========================================="
echo "Starting LeJEPA-CP (random init): ${DISPLAY_NAME} (n=10000)"
