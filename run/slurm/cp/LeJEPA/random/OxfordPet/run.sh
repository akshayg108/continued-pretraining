...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-rand-oxford_pet-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-rand-oxford_pet-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/random/OxfordPet"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/random/OxfordPet"
...
echo ""
echo "=========================================="
echo "Starting LeJEPA-CP (random): ${DISPLAY_NAME} (random)"
