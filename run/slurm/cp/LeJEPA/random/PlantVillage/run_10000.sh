#!/bin/bash
#SBATCH --job-name=lr-plantv-10000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-rand-plant_village-10000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-rand-plant_village-10000-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/random/PlantVillage/10000"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/random/PlantVillage/10000"
...
echo ""
echo "=========================================="
echo "Starting LeJEPA-CP (random): ${DISPLAY_NAME} (random, 10000)"
