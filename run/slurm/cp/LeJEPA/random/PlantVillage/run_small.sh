#!/bin/bash
#SBATCH --job-name=lr-plantv-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-rand-plant_village-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-rand-plant_village-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/random/PlantVillage/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/random/PlantVillage/small"
...
run_single() {
    ...
    python -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project lejepa-cp-random-scratch-${DATASET} \
...
echo ""
echo "=========================================="
echo "Starting LeJEPA-CP (random): ${DISPLAY_NAME} (random, small)"
...
echo ""
echo "=========================================="
echo "All LeJEPA-CP (random) ${DISPLAY_NAME} ${BACKBONE_TAG} experiments completed!"
