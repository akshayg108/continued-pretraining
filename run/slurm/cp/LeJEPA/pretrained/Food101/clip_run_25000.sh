...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-food101-clip-25k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-food101-clip-25k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/pretrained/Food101/CLIP/25k"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/pretrained/Food101/CLIP/25k"
...
echo ""
echo "=========================================="
echo "Starting LeJEPA-CP: ${DISPLAY_NAME} (n=25000)"
...
echo ""
echo "=========================================="
echo "All LeJEPA-CP ${DISPLAY_NAME} n=25000 experiments completed!"
