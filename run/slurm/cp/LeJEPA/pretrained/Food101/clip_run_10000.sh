...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-food101-clip-10k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-food101-clip-10k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/pretrained/Food101/CLIP/10k"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/pretrained/Food101/CLIP/10k"
...
echo ""
echo "=========================================="
echo "Starting LeJEPA-CP: ${DISPLAY_NAME} (n=10000)"
...
echo ""
echo "=========================================="
echo "All LeJEPA-CP ${DISPLAY_NAME} n=10000 experiments completed!"
