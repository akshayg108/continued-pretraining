...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-breastmnist-siglip-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-breastmnist-%j.err
...
BASE_CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/pretrained/BreastMNIST"
BASE_LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/pretrained/BreastMNIST"
...
echo ""
echo "=========================================="
echo "Starting LeJEPA-CP: ${DISPLAY_NAME} (All Backbones)"
echo "freeze_epochs=${FREEZE_EPOCHS} num_trained_blocks=${NUM_TRAINED_BLOCKS}"
echo "Seeds: ${SEEDS[*]}"
echo "=========================================="
echo ""
...
echo ""
echo "=========================================="
echo "All LeJEPA-CP ${DISPLAY_NAME} experiments completed!"
