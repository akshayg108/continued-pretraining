...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-galaxy10-clip-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-galaxy10-clip-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/pretrained/Galaxy10/CLIP/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/pretrained/Galaxy10/CLIP/small"
