#!/bin/bash
#SBATCH --job-name=l-plvi-cli-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-plant_village-clip-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-plant_village-clip-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/pretrained/PlantVillage/CLIP/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/pretrained/PlantVillage/CLIP/small"
...
echo ""
echo "=========================================="
echo "Starting LeJEPA-CP: ${DISPLAY_NAME} (CLIP, small)"
