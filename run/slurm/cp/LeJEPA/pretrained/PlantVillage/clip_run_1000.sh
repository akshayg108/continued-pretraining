#!/bin/bash
#SBATCH --job-name=l-plantv-cli-1000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-plant_village-clip-1000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-plant_village-clip-1000-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/pretrained/PlantVillage/1000"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/pretrained/PlantVillage/1000"
...
echo ""
echo "=========================================="
echo "Starting LeJEPA-CP: ${DISPLAY_NAME} (CLIP, 1000)"
