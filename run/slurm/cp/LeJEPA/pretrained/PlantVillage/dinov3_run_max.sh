#!/bin/bash
#SBATCH --job-name=l-plvi-din-max
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-plant_village-dinov3-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-plant_village-dinov3-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/pretrained/PlantVillage/DINOv3/max"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/pretrained/PlantVillage/DINOv3/max"
...
echo ""
echo "=========================================="
echo "Starting LeJEPA-CP: ${DISPLAY_NAME} (DINOv3, max)"
