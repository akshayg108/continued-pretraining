#!/bin/bash
#SBATCH --job-name=l-plvi-cli-max
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-plant_village-clip-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-plant_village-clip-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/pretrained/PlantVillage/CLIP/all"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/pretrained/PlantVillage/CLIP/all"
...
echo ""
echo "=========================================="
echo "Starting LeJEPA-CP: ${DISPLAY_NAME} (CLIP, max)"
