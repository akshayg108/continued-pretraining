#!/bin/bash
#SBATCH --job-name=l-plvi-din-10000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-plant_village-dinov3-10000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-plant_village-dinov3-10000-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/pretrained/PlantVillage/DINOv3/10000"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/pretrained/PlantVillage/DINOv3/10000"
...
echo ""
echo "=========================================="
echo "Starting LeJEPA-CP: ${DISPLAY_NAME} (DINOv3, 10000)"
