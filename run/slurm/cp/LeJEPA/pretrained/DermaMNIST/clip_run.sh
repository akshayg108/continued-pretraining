...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-dermamnist-clip-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-dermamnist-clip-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/pretrained/DermaMNIST/CLIP"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/pretrained/DermaMNIST/CLIP"
