...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-pathmnist-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-pathmnist-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/pretrained/PathMNIST/SigLIP/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/pretrained/PathMNIST/SigLIP/small"
