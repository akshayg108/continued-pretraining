...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-organamnist-clip-10k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-organamnist-clip-10k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/pretrained/OrganAMNIST/CLIP/10k"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/pretrained/OrganAMNIST/CLIP/10k"
...
echo ""
echo "=========================================="
echo "All LeJEPA-CP ${DISPLAY_NAME} 10k experiments completed!"
