...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-eurosat-dinov3-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-eurosat-dinov3-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/pretrained/EuroSAT/DINOv3/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/pretrained/EuroSAT/DINOv3/small"
