#!/bin/bash
#SBATCH --job-name=l-euro-din-10000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-eurosat-dinov3-10000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-eurosat-dinov3-10000-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/LeJEPA/pretrained/EuroSAT/DINOv3/10000"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/LeJEPA/pretrained/EuroSAT/DINOv3/10000"
