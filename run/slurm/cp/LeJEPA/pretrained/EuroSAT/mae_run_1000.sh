#!/bin/bash
#SBATCH --job-name=l-eurosat-mae-1000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-eurosat-mae-1000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/lejepa-eurosat-mae-1000-%j.err
