...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-octmnist-mae-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-octmnist-mae-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/pretrained/OctMNIST/MAE/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/pretrained/OctMNIST/MAE/small"
