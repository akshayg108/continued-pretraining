...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-organamnist-clip-10k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-organamnist-clip-10k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/pretrained/OrganAMNIST/CLIP/10k"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/pretrained/OrganAMNIST/CLIP/10k"
...
echo ""
echo "=========================================="
echo "Starting MAE-CP: ${DISPLAY_NAME} (n=10000)"
...
echo ""
echo "=========================================="
echo "All MAE-CP ${DISPLAY_NAME} 10k experiments completed!"
