...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-organamnist-clip-25k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-organamnist-clip-25k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/pretrained/OrganAMNIST/CLIP/25k"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/pretrained/OrganAMNIST/CLIP/25k"
...
echo ""
echo "=========================================="
echo "Starting MAE-CP: ${DISPLAY_NAME} (n=25000)"
...
echo ""
echo "=========================================="
echo "All MAE-CP ${DISPLAY_NAME} 25k experiments completed!"
