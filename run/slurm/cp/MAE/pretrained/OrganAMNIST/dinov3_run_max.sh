...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-organamnist-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-organamnist-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/pretrained/OrganAMNIST/DINOv3/all"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/pretrained/OrganAMNIST/DINOv3/all"
...
echo ""
echo "=========================================="
echo "Starting MAE-CP: ${DISPLAY_NAME} (MAX n=34561)"
...
echo ""
echo "=========================================="
echo "All MAE-CP ${DISPLAY_NAME} MAX experiments completed!"
