...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-pathmnist-clip-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-pathmnist-clip-max-%j.err
