...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-pathmnist-mae-25k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-pathmnist-mae-25k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/pretrained/PathMNIST/MAE/25k"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/pretrained/PathMNIST/MAE/25k"
