...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-pathmnist-clip-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-pathmnist-clip-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/pretrained/PathMNIST/CLIP/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/pretrained/PathMNIST/CLIP/small"
