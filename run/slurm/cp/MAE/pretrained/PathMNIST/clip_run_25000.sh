...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-pathmnist-clip-25k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-pathmnist-clip-25k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/pretrained/PathMNIST/CLIP/25k"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/pretrained/PathMNIST/CLIP/25k"
...
echo ""
echo "=========================================="
echo "All MAE-CP ${DISPLAY_NAME} n=25000 experiments completed!"
