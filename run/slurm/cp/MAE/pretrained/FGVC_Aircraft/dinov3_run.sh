...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-fgvc_aircraft-dinov3-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-fgvc_aircraft-dinov3-%j.err
