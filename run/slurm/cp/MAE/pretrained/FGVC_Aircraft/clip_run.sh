...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-fgvc_aircraft-clip-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-fgvc_aircraft-clip-%j.err
