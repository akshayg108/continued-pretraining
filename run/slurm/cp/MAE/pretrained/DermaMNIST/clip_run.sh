...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-dermamnist-clip-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-dermamnist-clip-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/pretrained/DermaMNIST/CLIP"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/pretrained/DermaMNIST/CLIP"
