#!/bin/bash
#SBATCH --job-name=m-euro-din-max
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-eurosat-dinov3-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-eurosat-dinov3-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/pretrained/EuroSAT/DINOv3/max"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/pretrained/EuroSAT/DINOv3/max"
