#!/bin/bash
#SBATCH --job-name=m-euro-cli-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-eurosat-clip-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-eurosat-clip-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/pretrained/EuroSAT/CLIP/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/pretrained/EuroSAT/CLIP/small"
