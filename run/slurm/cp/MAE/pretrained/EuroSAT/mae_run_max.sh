#!/bin/bash
#SBATCH --job-name=m-euro-mae-max
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-eurosat-mae-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-eurosat-mae-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/pretrained/EuroSAT/MAE/all"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/pretrained/EuroSAT/MAE/all"
