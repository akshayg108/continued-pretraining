#!/bin/bash
#SBATCH --job-name=m-plvi-cli-max
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-plant_village-clip-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-plant_village-clip-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/pretrained/PlantVillage/CLIP/max"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/pretrained/PlantVillage/CLIP/max"
...
echo ""
echo "=========================================="
echo "Starting MAE-CP: ${DISPLAY_NAME} (CLIP, max)"
