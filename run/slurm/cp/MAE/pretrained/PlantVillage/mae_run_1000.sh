#!/bin/bash
#SBATCH --job-name=m-plantv-mae-1000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-plant_village-mae-1000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-plant_village-mae-1000-%j.err
...
echo ""
echo "=========================================="
echo "Starting MAE-CP: ${DISPLAY_NAME} (MAE, 1000)"
