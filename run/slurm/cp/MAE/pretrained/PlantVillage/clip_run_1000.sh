#!/bin/bash
#SBATCH --job-name=m-plantv-cli-1000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-plant_village-clip-1000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-plant_village-clip-1000-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/pretrained/PlantVillage/1000"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/pretrained/PlantVillage/1000"
...
echo ""
echo "=========================================="
echo "Starting MAE-CP: ${DISPLAY_NAME} (CLIP, 1000)"
