#!/bin/bash
#SBATCH --job-name=m-plvi-mae-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-plant_village-mae-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-plant_village-mae-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/pretrained/PlantVillage/MAE/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/pretrained/PlantVillage/MAE/small"
...
echo ""
echo "=========================================="
echo "Starting MAE-CP: ${DISPLAY_NAME} (MAE, small)"
