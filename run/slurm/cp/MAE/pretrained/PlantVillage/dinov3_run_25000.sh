#!/bin/bash
#SBATCH --job-name=m-plvi-din-25000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-plant_village-dinov3-25000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-plant_village-dinov3-25000-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/pretrained/PlantVillage/DINOv3/25000"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/pretrained/PlantVillage/DINOv3/25000"
...
echo ""
echo "=========================================="
echo "Starting MAE-CP: ${DISPLAY_NAME} (DINOv3, 25000)"
