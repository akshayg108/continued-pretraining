...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-octmnist-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-octmnist-max-%j.err
...
echo ""
echo "=========================================="
echo "Starting MAE-CP (random init): ${DISPLAY_NAME} (MAX: 97477)"
