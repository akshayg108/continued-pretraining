...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-breastmnist-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-breastmnist-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/random/BreastMNIST"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/random/BreastMNIST"
...
run_single() {
    ...
    python -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project mae-cp-rand-breastmnist \
...
echo ""
echo "=========================================="
echo "Starting MAE-CP (random init): ${DISPLAY_NAME} (all: 100,500,546)"
...
echo ""
echo "=========================================="
echo "All MAE-CP (random) ${DISPLAY_NAME} experiments completed!"
