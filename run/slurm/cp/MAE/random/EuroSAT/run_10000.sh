#!/bin/bash
#SBATCH --job-name=mr-eurosat-10000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-eurosat-10000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-eurosat-10000-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/random/EuroSAT/10000"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/random/EuroSAT/10000"
