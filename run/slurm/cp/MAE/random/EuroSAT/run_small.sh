#!/bin/bash
#SBATCH --job-name=mr-eurosat-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-eurosat-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-eurosat-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/random/EuroSAT/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/random/EuroSAT/small"
