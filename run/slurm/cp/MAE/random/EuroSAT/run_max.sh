#!/bin/bash
#SBATCH --job-name=mr-eurosat-max
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-eurosat-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-eurosat-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/random/EuroSAT/max"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/random/EuroSAT/max"
