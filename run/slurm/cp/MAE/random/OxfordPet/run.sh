...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-oxford_pet-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-oxford_pet-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/random/OxfordPet"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/random/OxfordPet"
...
echo ""
echo "=========================================="
echo "Starting MAE-CP (random): ${DISPLAY_NAME} (random)"
