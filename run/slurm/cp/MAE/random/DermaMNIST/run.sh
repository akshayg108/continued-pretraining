...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-dermamnist-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-dermamnist-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/random/DermaMNIST"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/random/DermaMNIST"
...
run_single() {
    ...
    python -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project mae-cp-rand-dermamnist \
...
echo ""
echo "=========================================="
echo "Starting MAE-CP (random init): ${DISPLAY_NAME} (all: 100,500,1000,7007)"
