#!/bin/bash
#SBATCH --job-name=mr-plantv-10000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-plant_village-10000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-plant_village-10000-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/random/PlantVillage/10000"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/random/PlantVillage/10000"
...
echo ""
echo "=========================================="
echo "Starting MAE-CP (random): ${DISPLAY_NAME} (random, 10000)"
