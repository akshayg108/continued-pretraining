#!/bin/bash
#SBATCH --job-name=mr-plantv-25000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-plant_village-25000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-plant_village-25000-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/random/PlantVillage/25000"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/random/PlantVillage/25000"
...
echo ""
echo "=========================================="
echo "Starting MAE-CP (random): ${DISPLAY_NAME} (random, 25000)"
