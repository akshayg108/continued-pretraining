#!/bin/bash
#SBATCH --job-name=mr-plantv-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-plant_village-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-plant_village-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/random/PlantVillage/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/random/PlantVillage/small"
...
run_single() {
    ...
    echo "=========================================="
    echo "[RUN] MAE-CP (random) ${BACKBONE_TAG} | ${DATASET} | n=${n_samples} | seed=${seed}"
    ...
    python -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project mae-cp-random-scratch-${DATASET} \
...
echo ""
echo "=========================================="
echo "Starting MAE-CP (random): ${DISPLAY_NAME} (random, small)"
...
echo ""
echo "=========================================="
echo "All MAE-CP (random) ${DISPLAY_NAME} ${BACKBONE_TAG} experiments completed!"
