...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-food101-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-food101-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/random/Food101"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/random/Food101"
...
echo ""
echo "=========================================="
echo "Starting MAE-CP (random init): ${DISPLAY_NAME} (small: 101,500,1000)"
