...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-fgvc-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-fgvc-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/cp/MAE/random/FGVC_Aircraft"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/cp/MAE/random/FGVC_Aircraft"
...
run_single() {
    ...
    python -u continued_pretraining.py \
        ...
        --cache-dir ${DATA_DIR} \
        --project mae-cp-rand-fgvc_aircraft \
