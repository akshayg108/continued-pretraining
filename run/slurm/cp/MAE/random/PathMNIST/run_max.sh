...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-pathmnist-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/mae-rand-pathmnist-max-%j.err
...
echo ""
echo "=========================================="
echo "Starting MAE-CP (random init): ${DISPLAY_NAME} (MAX: 89996)"
