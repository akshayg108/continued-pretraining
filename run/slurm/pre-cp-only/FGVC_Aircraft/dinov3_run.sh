#!/bin/bash
#SBATCH --job-name=pre-fgvc-dinov3
...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/pre-cp-fgvc_aircraft-dinov3-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/pre-cp-fgvc_aircraft-dinov3-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/ckpts/pre-cp-only/FGVC_Aircraft/DINOv3"
LOG_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/logs/pre-cp-only/FGVC_Aircraft/DINOv3"
