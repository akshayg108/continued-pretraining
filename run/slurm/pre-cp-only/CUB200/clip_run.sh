#!/bin/bash
#SBATCH --job-name=pre-cub200-clip
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-cub200-clip-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-cub200-clip-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/CUB200/CLIP"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/CUB200/CLIP"
