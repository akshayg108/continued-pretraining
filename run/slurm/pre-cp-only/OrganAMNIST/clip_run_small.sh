#!/bin/bash
#SBATCH --job-name=pre-organ-clip-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-organamnist-clip-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-organamnist-clip-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/OrganAMNIST/CLIP/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/OrganAMNIST/CLIP/small"
