#!/bin/bash
#SBATCH --job-name=pre-organ-dinov3-10k
...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/pre-cp-organamnist-dinov3-10k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/pre-cp-organamnist-dinov3-10k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/ckpts/pre-cp-only/OrganAMNIST/DINOv3/10k"
LOG_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/logs/pre-cp-only/OrganAMNIST/DINOv3/10k"
...
echo ""
echo "=========================================="
echo "Starting Pre-CP-Only: ${DISPLAY_NAME} (${BACKBONE_TAG}, 10k)"
