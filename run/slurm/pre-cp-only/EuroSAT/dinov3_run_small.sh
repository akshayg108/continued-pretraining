#!/bin/bash
#SBATCH --job-name=pre-eurosat-dinov3-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-eurosat-dinov3-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-eurosat-dinov3-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/EuroSAT/DINOv3/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/EuroSAT/DINOv3/small"
