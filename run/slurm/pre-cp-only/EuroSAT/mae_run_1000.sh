#!/bin/bash
#SBATCH --job-name=pre-eurosat-mae-1000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-eurosat-mae-1000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-eurosat-mae-1000-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/EuroSAT/MAE/1000"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/EuroSAT/MAE/1000"
