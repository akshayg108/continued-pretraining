#!/bin/bash
#SBATCH --job-name=pre-plantv-clip-10000
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-plant_village-clip-10000-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-plant_village-clip-10000-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/PlantVillage/CLIP/10000"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/PlantVillage/CLIP/10000"
