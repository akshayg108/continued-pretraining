#!/bin/bash
#SBATCH --job-name=pre-plantv-dinov3-max
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-plant_village-dinov3-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-plant_village-dinov3-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/PlantVillage/DINOv3/max"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/PlantVillage/DINOv3/max"
