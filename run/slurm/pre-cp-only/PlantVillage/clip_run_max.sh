#!/bin/bash
#SBATCH --job-name=pre-plantv-clip-max
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-plant_village-clip-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-plant_village-clip-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/PlantVillage/CLIP/max"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/PlantVillage/CLIP/max"
