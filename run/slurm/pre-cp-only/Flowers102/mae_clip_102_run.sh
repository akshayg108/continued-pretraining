...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-flowers102-mae-clip-102-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-flowers102-mae-clip-102-%j.err
...
echo ""
echo "=========================================="
echo "Starting Pre-CP-Only: ${DISPLAY_NAME} (MAE + CLIP, n=102)"
echo "Seeds: ${SEEDS[*]}"
echo "=========================================="
echo ""
