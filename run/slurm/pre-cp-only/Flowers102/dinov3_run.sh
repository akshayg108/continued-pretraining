#!/bin/bash
#SBATCH --job-name=pre-flowers-dinov3
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-flowers102-dinov3-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-flowers102-dinov3-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/Flowers102/DINOv3"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/Flowers102/DINOv3"
