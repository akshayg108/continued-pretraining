#!/bin/bash
#SBATCH --job-name=pre-cars196-mae
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-cars196-mae-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-cars196-mae-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/Cars196/MAE"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/Cars196/MAE"
