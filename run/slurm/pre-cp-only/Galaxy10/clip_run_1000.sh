#!/bin/bash
#SBATCH --job-name=pre-galaxy-clip-1k
...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/pre-cp-galaxy10-clip-1k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/pre-cp-galaxy10-clip-1k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/ckpts/pre-cp-only/Galaxy10/CLIP/1k"
LOG_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/logs/pre-cp-only/Galaxy10/CLIP/1k"
