#!/bin/bash
#SBATCH --job-name=pre-path-clip-25k
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-pathmnist-clip-25k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-pathmnist-clip-25k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/PathMNIST/CLIP/25k"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/PathMNIST/CLIP/25k"
...
echo ""
echo "=========================================="
echo "Starting Pre-CP-Only: ${DISPLAY_NAME} (CLIP, n=25000)"
