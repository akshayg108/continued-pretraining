...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/precp-eurosat-siglip-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/precp-eurosat-siglip-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/pretrained/EuroSAT/SigLIP/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/pretrained/EuroSAT/SigLIP/small"
