...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/precp-dermamnist-siglip-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/precp-dermamnist-siglip-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/pretrained/DermaMNIST/SigLIP"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/pretrained/DermaMNIST/SigLIP"
...
echo ""
echo "=========================================="
echo "Starting Pre-CP eval: ${DISPLAY_NAME}"
