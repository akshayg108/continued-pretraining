...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/precp-galaxy10-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/precp-galaxy10-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/pretrained/Galaxy10/SigLIP/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/pretrained/Galaxy10/SigLIP/small"
