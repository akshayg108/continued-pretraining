...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/precp-breastmnist-siglip-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/precp-breastmnist-%j.err
...
BASE_CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/pretrained/BreastMNIST"
BASE_LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/pretrained/BreastMNIST"
...
BACKBONE_TIMMS[SigLIP]="vit_base_patch16_siglip_224.v2_webli"

declare -A BACKBONE_NSAMPLES
BACKBONE_NSAMPLES[SigLIP]="546"

declare -A POOL_STRATEGIES
POOL_STRATEGIES[SigLIP]="map"
...
run_single() {
    ...
    local wandb_project="lejepa-cp-$(echo ${backbone_tag} | tr '[:upper:]' '[:lower:]')-${DATASET}"
...
echo ""
echo "=========================================="
echo "Starting Pre-CP eval: ${DISPLAY_NAME} (All Backbones)"
echo "freeze_epochs=${FREEZE_EPOCHS} num_trained_blocks=${NUM_TRAINED_BLOCKS}"
echo "Seeds: ${SEEDS[*]}"
echo "=========================================="
echo ""
...
echo ""
echo "=========================================="
echo "All Pre-CP eval ${DISPLAY_NAME} experiments completed!"
