...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/pretrained/CUB200/SigLIP"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/pretrained/CUB200/SigLIP"
