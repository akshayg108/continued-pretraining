...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/pretrained/PathMNIST/SigLIP/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/pretrained/PathMNIST/SigLIP/small"
