#!/bin/bash
#SBATCH --job-name=p-plvi-din-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/precp-plant_village-siglip-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/precp-plant_village-siglip-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/pretrained/PlantVillage/SigLIP/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/pretrained/PlantVillage/SigLIP/small"
...
echo ""
echo "=========================================="
echo "Starting Pre-CP eval: ${DISPLAY_NAME} (SigLIP, small)"
