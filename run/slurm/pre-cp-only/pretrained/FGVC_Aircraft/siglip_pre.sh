...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/precp-fgvc_aircraft-siglip-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/precp-fgvc_aircraft-siglip-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/pretrained/FGVC_Aircraft/SigLIP"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/pretrained/FGVC_Aircraft/SigLIP"
