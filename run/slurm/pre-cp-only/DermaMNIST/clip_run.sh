#!/bin/bash
#SBATCH --job-name=pre-derma-clip
...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/pre-cp-dermamnist-clip-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/pre-cp-dermamnist-clip-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/ckpts/pre-cp-only/DermaMNIST/CLIP"
LOG_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/logs/pre-cp-only/DermaMNIST/CLIP"
