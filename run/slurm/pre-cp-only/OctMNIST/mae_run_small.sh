#!/bin/bash
#SBATCH --job-name=pre-oct-mae-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-octmnist-mae-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-octmnist-mae-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/OctMNIST/MAE/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/OctMNIST/MAE/small"
...
echo ""
echo "=========================================="
echo "Starting Pre-CP-Only: ${DISPLAY_NAME} (MAE, n=small: 100,500,1000)"
