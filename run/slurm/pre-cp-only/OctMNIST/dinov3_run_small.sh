#!/bin/bash
#SBATCH --job-name=pre-oct-dinov3-small
...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/pre-cp-octmnist-dinov3-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/pre-cp-octmnist-dinov3-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/ckpts/pre-cp-only/OctMNIST/DINOv3/small"
LOG_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/logs/pre-cp-only/OctMNIST/DINOv3/small"
...
for i, seed in enumerate(seeds):
    results_file = os.oct.join(log_dir, f"{backbone_tag}_{dataset}_n{n_samples}_seed{seed}.json")
    if not os.oct.exists(results_file):
...
echo ""
echo "=========================================="
echo "Starting Pre-CP-Only: ${DISPLAY_NAME} (DINOv3, n=small: 100,500,1000)"
