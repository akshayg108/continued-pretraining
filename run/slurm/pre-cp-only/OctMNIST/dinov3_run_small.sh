...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-octmnist-dinov3-small-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-octmnist-dinov3-small-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/OctMNIST/DINOv3/small"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/OctMNIST/DINOv3/small"
