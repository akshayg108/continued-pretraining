#!/bin/bash
#SBATCH --job-name=pre-oct-dinov3-25k
...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/pre-cp-octmnist-dinov3-25k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/pre-cp-octmnist-dinov3-25k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/ckpts/pre-cp-only/OctMNIST/DINOv3/25k"
LOG_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/logs/pre-cp-only/OctMNIST/DINOv3/25k"
