...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-octmnist-mae-max-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-octmnist-mae-max-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/OctMNIST/MAE/max"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/OctMNIST/MAE/max"
