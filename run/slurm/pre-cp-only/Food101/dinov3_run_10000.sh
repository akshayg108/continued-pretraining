#!/bin/bash
#SBATCH --job-name=pre-food-dinov3-10k
...
#SBATCH --output=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/pre-cp-food101-dinov3-10k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP-MAE/outputs/slurm-log/pre-cp-food101-dinov3-10k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/ckpts/pre-cp-only/Food101/DINOv3/10k"
LOG_DIR="/scratch/gs4133/zhd/CP-MAE/outputs/logs/pre-cp-only/Food101/DINOv3/10k"
