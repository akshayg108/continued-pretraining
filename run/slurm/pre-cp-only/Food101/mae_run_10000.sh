#!/bin/bash
#SBATCH --job-name=pre-food-mae-10k
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-food101-mae-10k-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-food101-mae-10k-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/Food101/MAE/10k"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/Food101/MAE/10k"
