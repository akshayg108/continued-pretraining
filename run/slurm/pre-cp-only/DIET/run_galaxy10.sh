...
#SBATCH --output=/scratch/gs4133/zhd/Continued-Pretraining/outputs/logs/pre-cp-only/DIET/slurm-log/pre-cp-diet-galaxy10-%j.out
#SBATCH --error=/scratch/gs4133/zhd/Continued-Pretraining/outputs/logs/pre-cp-only/DIET/slurm-log/pre-cp-diet-galaxy10-%j.err
...
# Galaxy10 MAX=14188
# ============================================================
DINOV3_NSAMPLES=(100 500 1000 10000 14188)
MAE_NSAMPLES=(1000 14188)
CLIP_NSAMPLES=(1000 14188)
