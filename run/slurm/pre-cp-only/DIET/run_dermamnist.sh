#!/bin/bash
#SBATCH --job-name=pre-cp-diet-dermamnist
...
#SBATCH --output=/scratch/gs4133/zhd/Continued-Pretraining/outputs/logs/pre-cp-only/DIET/slurm-log/pre-cp-diet-dermamnist-%j.out
#SBATCH --error=/scratch/gs4133/zhd/Continued-Pretraining/outputs/logs/pre-cp-only/DIET/slurm-log/pre-cp-diet-dermamnist-%j.err
...
# DermaMNIST MAX=7007
# ============================================================
DINOV3_NSAMPLES=(100 500 1000 7007)
MAE_NSAMPLES=(1000 7007)
CLIP_NSAMPLES=(1000 7007)
