#!/bin/bash
#SBATCH --job-name=pre-cp-diet-octmnist
...
#SBATCH --output=/scratch/gs4133/zhd/Continued-Pretraining/outputs/logs/pre-cp-only/DIET/slurm-log/pre-cp-diet-octmnist-%j.out
#SBATCH --error=/scratch/gs4133/zhd/Continued-Pretraining/outputs/logs/pre-cp-only/DIET/slurm-log/pre-cp-diet-octmnist-%j.err
...
# OCTMNIST MAX=97477
# ============================================================
DINOV3_NSAMPLES=(100 500 1000 10000 25000 97477)
MAE_NSAMPLES=(1000 97477)
CLIP_NSAMPLES=(1000 97477)
