...
#SBATCH --output=/scratch/gs4133/zhd/Continued-Pretraining/outputs/logs/pre-cp-only/DIET/slurm-log/pre-cp-diet-organamnist-%j.out
#SBATCH --error=/scratch/gs4133/zhd/Continued-Pretraining/outputs/logs/pre-cp-only/DIET/slurm-log/pre-cp-diet-organamnist-%j.err
...
# ============================================================
DINOV3_NSAMPLES=(100 500 1000 10000 25000 34561)
MAE_NSAMPLES=(1000 34561)
CLIP_NSAMPLES=(1000 34561)
