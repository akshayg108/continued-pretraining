...
#SBATCH --output=/scratch/gs4133/zhd/Continued-Pretraining/outputs/logs/pre-cp-only/DIET/slurm-log/pre-cp-diet-pathmnist-%j.out
#SBATCH --error=/scratch/gs4133/zhd/Continued-Pretraining/outputs/logs/pre-cp-only/DIET/slurm-log/pre-cp-diet-pathmnist-%j.err
...
# PathMNIST MAX=89996
# ============================================================
DINOV3_NSAMPLES=(100 500 1000 10000 25000 89996)
MAE_NSAMPLES=(1000 89996)
CLIP_NSAMPLES=(1000 89996)
