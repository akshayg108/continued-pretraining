#!/bin/bash
#SBATCH --job-name=pre-cp-diet-test
...
#SBATCH --output=/scratch/gs4133/zhd/Continued-Pretraining/outputs/slurm-log/pre-cp-diet-test-%j.out
#SBATCH --error=/scratch/gs4133/zhd/Continued-Pretraining/outputs/slurm-log/pre-cp-diet-test-%j.err
...
# ============================================================
# Experiment lists: test only — Galaxy10 n=100
# ============================================================
DINOV3_NSAMPLES=(100)
MAE_NSAMPLES=(100)
CLIP_NSAMPLES=(100)
...
echo ""
echo "=========================================="
echo "Starting Pre-CP-Only TEST: ${DISPLAY_NAME} n=100"
