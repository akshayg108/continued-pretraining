...
#SBATCH --output=/scratch/gs4133/zhd/Continued-Pretraining/outputs/logs/pre-cp-only/DIET/slurm-log/pre-cp-diet-%j.out
#SBATCH --error=/scratch/gs4133/zhd/Continued-Pretraining/outputs/logs/pre-cp-only/DIET/slurm-log/pre-cp-diet-%j.err
...
# Each entry: "dataset n_samples"
# Extracted from results.csv  DIET-CP rows (Group=CP, Method=DIET)
# ============================================================
...
# ============================================================
# Get experiment array by backbone tag
# ============================================================
get_experiments() {
    local tag=$1
    case "$tag" in
        DINOv3) echo "${DINOV3_EXPERIMENTS[@]}" ;;
        MAE)    echo "${MAE_EXPERIMENTS[@]}" ;;
        CLIP)   echo "${CLIP_EXPERIMENTS[@]}" ;;
    esac
}
...
echo ""
echo "=========================================="
echo "Starting Pre-CP-Only Evaluation (DIET group, Pretrained Backbones)"
