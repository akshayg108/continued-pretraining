#!/bin/bash
#SBATCH --job-name=pre-oxpet-dinov3
...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-oxford_pet-dinov3-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-oxford_pet-dinov3-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/OxfordPet/DINOv3"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/OxfordPet/DINOv3"
