...
#SBATCH --output=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-breastmnist-mae-%j.out
#SBATCH --error=/scratch/gs4133/zhd/CP/outputs/slurm-log/pre-cp-breastmnist-mae-%j.err
...
CKPT_DIR="/scratch/gs4133/zhd/CP/outputs/ckpts/pre-cp-only/BreastMNIST/MAE"
LOG_DIR="/scratch/gs4133/zhd/CP/outputs/logs/pre-cp-only/BreastMNIST/MAE"
