...
def lp_config(epochs=150, batch_size=512, lr=1e-3, forward_batch_size=32):
    ...
    if type(forward_batch_size) is not int or forward_batch_size < 1:
        raise ValueError("LP forward batch size must be a positive integer")
